...
export default function PlanPage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        <h3 className="font-bold text-lg mb-4">Datos para transferencia bancaria</h3>
        ...
        <div className="bg-gray-50 rounded-xl p-5 space-y-2 text-sm">
          ...
          <div className="flex justify-between"><span className="text-gray-400">Pasaporte:</span><span className="font-semibold">{BANK_INFO.pasaporte}</span></div>
